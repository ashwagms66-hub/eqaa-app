...
const S = {
  ar: {
    ...
    subtitle: "افتحي الماسح الذكي، جدول التمرين، الصيام الذكي، وخطة يومية تناسب إيقاع جسمك.",
    features: [
    ...
    purchaseSuccess: "أهلاً بك في إيقاع Premium! 🎉",
    purchaseSuccessMsg: "تم تفعيل اشتراكك بنجاح.",
  ...
  en: {
    ...
    subtitle: "Unlock AI scanner, workout plans, smart fasting, and daily guidance for your body rhythm.",
    features: [
    ...
    purchaseSuccess: "Welcome to Eqa'a Premium! 🎉",
    purchaseSuccessMsg: "Your subscription is now active.",
...
export default function PaywallScreen() {
  ...
  // If already premium, close immediately
